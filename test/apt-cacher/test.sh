...
check "proxy config exists" bash -c "ls -la /etc/apt/apt.conf.d | grep 01proxy"

check "proxy host is bridge gateway" bash -c "cat /etc/apt/apt.conf.d/01proxy | grep '172.17.0.1'"
